...
(1, N'Abbott Laboratories', 1), 
(2, N'Alpha Grow Company', 1), 
(3, N'Meiji Co', 4), 
(4, N'Abbott Manufacturing Singapore Private Limited', 6), 
(5, N'Vinamilk', 5), 
(6, N'Wakodo', 4), 
(7, N'Royal Ausnz', 7), 
(8, N'Morinaga Milk Industry', 4), 
(9, N'FrieslandCampina', 10), 
(10, N'VitaDairy', 5), 
(11, N'Anmum', 11), 
(12, N'Mead Johnson Nutrition', 1), 
(13, N'Namyang Dairy Products', 9), 
(14, N'HOCHDORF Swiss Nutrition', 8), 
(15, N'Nutricare', 5),  
(16, N'Eneright Nutrition', 5), 
(17, N'Nestlé', 8),
(18, N'Aiwado', 4), 
(19, N'TGD', 5), 
(20, N'Royal Friesland Campina', 10), 
(21, N'Glico', 4), 
(22, N'Danone', 3), 
(23, N'Franci Việt Nam', 5), 
(24, N'Nutifood', 2),  
(25, N'Nutriking', 5),
(26, N'Nutricia', 10);
...
(28, N'NAN', 17),
(29, N'Aptamil', 22),
(30, N'Franci Việt Nam', 23),
(31, N'Nutifood', 24);

INSERT INTO Admin (AdminID, Username, Password, Role)
VALUES 
(1, N'Staff1@gmail.com', N'1', N'Staff'),
(2, N'Staff2@gmail.com', N'2', N'Staff'),
(3, N'Staff3@gmail.com', N'3', N'Staff'),
(4, N'Staff4@gmail.com', N'4', N'Staff'),
(5, N'Staff5@gmail.com', N'staff123', N'Staff'),
(6, N'bao@gmail.com', N'admin123', N'Admin');

INSERT INTO Customer (CustomerID, CustomerName, Email, Password, Phone) VALUES
(1, N'Customer 1', N'customer1@gmail.com', N'password1', '1234567890'),
(2, N'Customer 2', N'customer2@gmail.com', N'password2', '2345678901'),
(3, N'Customer 3', N'customer3@gmail.com', N'password3', '3456789012'),
(4, N'Customer 4', N'customer4@gmail.com', N'password4', '4567890123'),
(5, N'Customer 5', N'customer5@gmail.com', N'password5', '5678901234');
...
INSERT INTO DeliveryMan (DeliveryManID, DeliveryName, DeliveryStatus, PhoneNumber, StorageID, StorageName)
VALUES 
(1, N'DeliveryMan A', N'Sẵn sàng', '1234567890', 1, N'Hà Nội'),
(2, N'DeliveryMan B', N'Bận', '2234567891', 1, N'Hà Nội'),
(3, N'DeliveryMan C', N'Sẵn sàng', '3234567892', 2, N'TP Hồ Chí Minh'),
(4, N'DeliveryMan D', N'Bận', '4234567893', 2, N'TP Hồ Chí Minh'),
(5, N'DeliveryMan E', N'Sẵn sàng', '5234567894', 3, N'Đà Nẵng'),
(6, N'DeliveryMan F', N'Bận', '6234567895', 3, N'Đà Nẵng'),
(7, N'DeliveryMan G', N'Sẵn sàng', '7234567896', 4, N'Hải Phòng'),
(8, N'DeliveryMan H', N'Bận', '8234567897', 4, N'Hải Phòng'),
(9, N'DeliveryMan I', N'Sẵn sàng', '9234567898', 5, N'Bình Dương'),
(10, N'DeliveryMan J', N'Bận', '1234567899', 5, N'Bình Dương');

INSERT INTO ProductItem (ProductItemID, Benefit, Description, Image1, Image2, Image3, ItemName, Price, Weight, BrandMilkID, Baby, Mama, BrandName, CountryName, CompanyName, Discount, SoldQuantity, StockQuantity)
VALUES
(
    1,
...
(10, N'', N'1-8 tháng', 10),
(11, N'', N'1-9 tháng', 11),
(12, N'', N'1-10 tháng', 12),
(13, N'', N'1-11 tháng', 13),
(14, N'', N'1-12 tháng', 14),
(15, N'', N'1-13 tháng', 15),
(16, N'', N'1-14 tháng', 16),
(17, N'6 - 12 tháng', N'', 17),
(18, N'', N'1-15 tháng', 18),
(19, N'', N'3-5 tháng', 19),
(20, N'', N'3-6 tháng', 20),
(21, N'', N'3-7 tháng', 21),
(22, N'', N'3-8 tháng', 22),
(23, N'', N'3-9 tháng', 23),
(24, N'', N'3-10 tháng', 24),
(25, N'', N'3-11 tháng', 25),
(26, N'', N'3-12 tháng', 26),
(27, N'1+ tuổi', N'', 27),
(28, N'0-12 tháng', N'', 28),
(29, N'6-24 tháng', N'', 29),
(30, N'0-12 tháng', N'', 30),
(31, N'0+', N'', 31),
(32, N'1+ tuổi', N'', 32),
(33, N'1 - 10 tuổi ', N'', 33),
(34, N'1 - 10 tuổi', N'', 34),
...
INSERT INTO [Order] (OrderID, CustomerID, DeliveryManID, DeliveryName, DeliveryPhone, OrderDate, ShippingAddress, TotalAmount, PaymentMethod, StorageID, [Status])
VALUES
    (1, 1, 1, N'DeliveryMan A', '1234567890', '2023-06-01', N'Số nhà 123, Ngõ 456, Đường Láng, Phường Láng Thượng, Quận Đống Đa, Hà Nội, Việt Nam', 585000.00, N'VnPay', 1, N'Đợi lấy hàng'),
    (2, 2, 3, N'DeliveryMan C', '2234567892', '2023-06-02', N'Số nhà 789, Đường 123, Phường Tân Phú, Quận 7, TP Hồ Chí Minh, Việt Nam', 988200.00, N'VnPay', 2, N'Đang giao hàng'),
    (3, 3, 5, N'DeliveryMan E', '3234567894', '2023-06-03', N'Số nhà 456, Đường 789, Phường Hòa Cường Bắc, Quận Hải Châu, Đà Nẵng, Việt Nam', 1269600.00, N'VnPay', 3, N'Đã giao hàng'),
    (4, 4, 7, N'DeliveryMan G', '4234567896', '2023-06-04', N'Số nhà 321, Đường 654, Phường Lê Chân, Quận Lê Chân, Hải Phòng, Việt Nam', 1920000.00, N'VnPay', 4, N'Đã giao hàng'),
    (5, 5, 9, N'DeliveryMan I', '5234567898', '2023-06-05', N'Số nhà 789, Đường 123, Phường Phú Lợi, Thành phố Thủ Dầu Một, Bình Dương, Việt Nam', 767975.00, N'VnPay', 5, N'Đang giao hàng');

    
INSERT INTO Payment (PaymentID, Amount, PaymentMethod, OrderID)
VALUES
    (1, 585000.00, N'VnPay', 1),
    (2, 988200.00, N'VnPay', 2),
    (3, 1269600.00, N'VnPay', 3),
    (4, 1920000.00, N'VnPay', 4),
    (5, 767975.00, N'VnPay', 5);
    

INSERT INTO OrderDetail (OrderDetailID, CustomerID, OrderID, ProductItemID, ItemName, Image, Quantity, Price, Discount, OrderStatus, StockQuantity)
VALUES
    (1, 1, 1, 1, N'Similac Advance', 'https://mebeplaza.com/wp-content/uploads/2020/08/similac-advance-1.13kg.jpg', 1, 650000.00, 10, 1, 250),
    (2, 2, 2, 2, N'Alpha Grow A+ NeuroPro', 'https://th.bing.com/th/id/OIP.6m4wJY2BlBLz_Mtkrw_qpgAAAA?rs=1&pid=ImgDetMain', 2, 549000.00, 10, 1, 530),
    (3, 3, 3, 3, N'Meiji 0-1 years old Infant Formula', 'https://cdn1.concung.com/2021/04/27426-72037/meiji-infant-formula-800g-0-12-thang.jpg', 3, 529000.00, 20, 2, 500),
    (4, 4, 4, 4, N'Abbott Pediasure Vanilla Flavor 1.6kg (1-10 years)', 'https://www.family.abbott/my-en/pediasure/products/pediasure-vanilla/_jcr_content/root/container/columncontrol_copy/tab_item_no_0/mediacarousel/item_1653228436183_c.coreimg.png/1669711037458/product-detail-component-pds-vanila.png', 4, 600000.00, 20, 1, 730),
    (5, 5, 5, 5, N'Optimum Mama Gold', 'https://cdn1.concung.com/2019/06/40489-50100/optimum-mama-gold-400g.jpg', 5, 180700.00, 15, 1, 490);
